      ...
      {status === "sent" ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <button
            ...
            className="px-6 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold rounded-xl text-sm disabled:opacity-50 hover:shadow-lg transition-all"
          >
